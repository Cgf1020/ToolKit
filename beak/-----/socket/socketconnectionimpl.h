...
namespace itflee {
	...
	public:		//SocketConnectInterface
		int connect(std::string const& uri, std::shared_ptr<SocketConnectListener> lister, const std::string& subprotocol = "") noexcept override;
	...
	private:
		SocketConnectEnum::StatusVal statu_;
	};
}
